...
<html>
	...
	<body>
		...
		<nav>
			<ul>
				<li id=here><a href="index.php">Accueil</a></li> 
	...
	<section>
       ...
       <p id="presentation">Vous pourrez consulter des <a id="link" href="exemple.php">exemples</a> de code, et vous pourrez jouer la mélodie en effet vous vous rendrez compte que la programmation est un vrai jeu d'enfant !
		Enfin pour commencer vous pouvez vous amusez avec le piano ci-dessous. Vous pouvez l'utiliser en cliquant sur les boutons noirs et blancs ci-dessous ou en appuyant sur les touches du clavier indiquées au dessus du piano! Bonne visite.</p>
	<video src="FilmPT.webm" controls width="680px"></video>
       ...
       <form method="get" action="index.php#piano" id="piano">
		   <div>
            <div class="piano">
					  <div id="piano-container">
						...
						<li>                
						  <input type="submit" value="Ré" class="blanc" name="case3"/>
						   <p class="lettre3">S</p>
						  <input type="submit" value="Ré#" class="noire" name="case4"/> 
						  <p class="lettre4">D</p> 
						</li> 
						<li>                
						...
						<li>                
						  ...
						  <p class="lettre">F</p>
						  <input type="submit" value="Fa#" class="noire" name="case7"/>  
						  <p class="lettre2">G</p>    
						</li> 
						<li>                
						  <input type="submit" value="Sol" class="blanc" name="case8"/>
						  <p class="lettre3">Y</p>    
						  <input type="submit" value="Sol#" class="noire" name="case9"/>
						  <p class="lettre2">H</p>    
						</li> 
						<li>                
						  <input type="submit" value="La" class="blanc" name="case10"/>
						  <p class="lettre3">J</p>    
						  <input type="submit" value="La#" class="noire" name="case11"/>
						  <p class="lettre2">I</p>       
						</li> 
						<li>                
						  <input type="submit" value="Si" class="blanc" name="case12"/>
						  <p class="lettre3">K</p>    
						</li> 
						<li>
						  <input type="submit" value="Do" class="blanc" name="case14"/>
						  <p class="lettre3">P</p>    
						  <input type="submit" value="Do#" class="noire" name="case15"/>
						  <p class="lettre2">M</p>    
						</li>       
						<li>
						  <input type="submit" value="Ré" class="blanc" name="case16"/>
						  <p class="lettre3">4</p>    
						  <input type="submit" value="Ré#" class="noire" name="case17"/>
						  <p class="lettre2">8</p>    
						</li>
						<li>
						  <input type="submit" value="Mi" class="blanc" name="case18"/>
						  <p class="lettre3">5</p>    
						</li>  
					  </div>
					</div>
		...
		if(!empty($_GET)){
			...
			if(isset($_GET["valid"])){
				...
				shell_exec('> piano2.txt');
                        ...
                        echo '<script>window.location.replace("index.php#piano");</script>';
		}
	?>
	</section>
	<a id="atelier" href="session.php">Passer à l'atelier</a>
  <footer>
...
<script src="jquery-1.12.3.js"></script>
 ...
 function pianoClavier(e){
        ...
        if (actualkey=="q")
        {   
            window.location.href = "index.php?case1=Do%2Fq#piano";
        }
        if (actualkey=="z")
        {
            window.location.href = "index.php?case2=Do%27%2Fz#piano";
        }
        if (actualkey=="s")
        {
            window.location.href = "index.php?case3=Ré%2Fs#piano";
        }
        if (actualkey=="d")
        {
            window.location.href = "index.php?case4=Mi%2Fd#piano";
        }
        if (actualkey=="r")
        {
            window.location.href = "index.php?case5=Mi%27%2Fr#piano";
        }
        if (actualkey=="f")
        {
            window.location.href = "index.php?case6=Fa%2Ff#piano";
        }
        if (actualkey=="g")
        {
            window.location.href = "index.php?case7=Sol%2Fg#piano";
        }
        if (actualkey=="y")
        {
            window.location.href = "index.php?case8=Sol%27%2Fy#piano";
        }
        if (actualkey=="h")
        {
            window.location.href = "index.php?case9=La%2Fh#piano";
        }
        if (actualkey=="j")
        {
            window.location.href = "index.php?case10=Si%2Fj#piano";
        }
        if (actualkey=="i")
        {
            window.location.href = "index.php?case11=Si%27%2Fi#piano";
        }
        if (actualkey=="k")
        {
            window.location.href = "index.php?case12=Do%2Fk#piano";
        }
        if (actualkey=="p")
        {
            window.location.href = "index.php?case14=Ré%27%27%2Fp#piano";
        }
        if (actualkey=="m")
        {
            window.location.href = "index.php?case15=Mi%2Fm#piano";
        }
        if (actualkey=="4")
        {
            window.location.href = "index.php?case16=Fa%2F4#piano";
        }
        if (actualkey=="8")
        {
            window.location.href = "index.php?case17=Fa%27%27%2F8#piano";
        }
        if (actualkey=="5")
        {
            window.location.href = "index.php?case18=Sol%2F5#piano";
        }
    }

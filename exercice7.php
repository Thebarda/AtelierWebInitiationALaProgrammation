...
<html>
	...
	<div id="numero">
		...
		<p id="intitule">- Faire une première fonction « boucle » qui va :<br>
					<ul>
						...
						<li><b> Créez une boucle "Tant que" la variable note est inférieur à 80 qui va :
							<ul>
						 		<li> Jouez la « note »</li>
	...
	<progress id="progress" max="100" value="87.5">1/8</progress>
        <?php
		if(isset($_POST["refaire"])){
			shell_exec('> exercice7.txt');
			$_POST["code"] = null;
